...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('dashassets/src/plugins/datatables/css/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('dashassets/src/plugins/datatables/css/responsive.bootstrap4.min.css') }}">
        ...
        <div class="header-right">
            ...
            <div class="github-link">
                <a href="https://github.com/dropways/deskapp" target="_blank"><img
                        src="{{ asset('dashassets/vendors/images/github.svg') }}" alt=""></a>
            </div>
        </div>
    </div>
            ...
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            <li><a href="{{ route('categories.index') }}">Category Page</a></li>
