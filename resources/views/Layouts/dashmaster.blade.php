...
<head>
	...
	<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('dashassets/vendors/images/apple-touch-icon.png') }}">
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('dashassets/src/plugins/datatables/css/dataTables.bootstrap4.min.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('dashassets/src/plugins/datatables/css/responsive.bootstrap4.min.css') }}">
	...
	<div class="header">
		...
		<div class="header-right">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll">
							<ul>
								<li>
									<a href="#">
										<img src="{{ asset('dashassets/vendors/images/img.jpg') }}" alt="">
										<h3>John Doe</h3>
								...
								<li>
									<a href="#">
										<img src="{{ asset('dashassets/vendors/images/photo1.jpg') }}" alt="">
										<h3>Lea R. Frith</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="{{ asset('dashassets/vendors/images/photo2.jpg') }}" alt="">
								...
								<li>
									<a href="#">
										<img src="{{ asset('dashassets/vendors/images/photo4.jpg') }}" alt="">
				...
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span class="user-icon">
							<img src="dashassets/vendors/images/photo1.jpg" alt="">
						</span>
			...
			<div class="github-link">
				<a href="https://github.com/dropways/deskapp" target="_blank"><img src="{{asset('dashassets/vendors/images/github.svg')}}" alt=""></a>
			</div>
		</div>
	</div>
...
@yield('dashcontent1')
	...
	<script src="{{asset('dashassets/src/plugins/apexcharts/apexcharts.min.js') }}"></script>
	<script src="{{asset('dashassets/src/plugins/datatables/js/jquery.dataTables.min.js')}}"></script>
	<script src="{{asset('dashassets/src/plugins/datatables/js/dataTables.bootstrap4.min.js')}}"></script>
	<script src="{{asset('dashassets/src/plugins/datatables/js/dataTables.responsive.min.js')}}"></script>
	<script src="{{asset('dashassets/src/plugins/datatables/js/responsive.bootstrap4.min.js')}}"></script>
	<script src="{{asset('dashassets/vendors/scripts/dashboard.js')}}"></script>
</body>
</html>